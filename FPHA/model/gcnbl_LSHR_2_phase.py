    ...
    def Spherical_harm(self,x,l):
        ...
        for l in L:
            ...
            for m in M:
                ...
                result_p= torch.cat((result_p, test_phase),dim =1) if result_p is not None else test_phase
                # result: torch.Size([128, 21, 64, 25, 25]))test_phase
        return result_p#, result_r, result_i
